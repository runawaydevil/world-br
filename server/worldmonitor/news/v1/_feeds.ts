...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  ...
  br: {
    politics: [
      ...
      { name: 'Estadão', url: 'https://rss.estadao.com.br/geral' },
      { name: 'BBC Brasil', url: 'https://feeds.bbci.co.uk/portuguese/rss.xml' },
      { name: 'CNN Brasil', url: 'https://www.cnnbrasil.com.br/feed/' },
    ],
    latam: [
      { name: 'BBC América Latina', url: 'https://feeds.bbci.co.uk/news/world/latin_america/rss.xml' },
      { name: 'Guardian Americas', url: 'https://www.theguardian.com/world/americas/rss' },
      { name: 'France 24 Português', url: 'https://www.france24.com/pt/rss' },
    ],
    us: [
      { name: 'Reuters Brasil', url: gn('site:reuters.com.br OR site:reuters.com Brasil') },
      { name: 'NPR', url: 'https://feeds.npr.org/1001/rss.xml' },
    ],
    europe: [
      { name: 'DW Português', url: 'https://rss.dw.com/xml/rss-pt-all' },
      { name: 'Euronews', url: 'https://pt.euronews.com/rss' },
    ],
    asia: [
      { name: 'BBC Asia', url: 'https://feeds.bbci.co.uk/news/world/asia/rss.xml' },
    ],
    ...
    economic: [
      { name: 'Valor Econômico', url: 'https://www.valor.com.br/rss' },
      { name: 'BCB', url: 'https://www.bcb.gov.br/estabilidadefinanceira/rss' },
    ],
    commodities: [
      { name: 'Commodities', url: gn('(petróleo OR commodities OR "preço do dólar" OR "taxa selic") Brasil when:2d') },
    ],
    crypto: [
      { name: 'Cointelegraph Brasil', url: 'https://cointelegraph.com.br/rss' },
      { name: 'CriptoFacil', url: 'https://www.criptofacil.com/feed/' },
    ],
    tech: [
      { name: 'TecMundo', url: 'https://www.tecmundo.com.br/rss' },
      { name: 'Olhar Digital', url: 'https://olhardigital.com.br/rss' },
      { name: 'Canaltech', url: 'https://canaltech.com.br/feed/' },
    ],
    energy: [
      { name: 'Energia', url: gn('(energia OR "pré-sal" OR Petrobras OR "geração de energia") Brasil when:2d') },
    ],
  },
