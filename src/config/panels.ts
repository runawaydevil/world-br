...
// ============================================
// BR VARIANT (Brasil — português do Brasil)
// ============================================
const BR_PANELS: Record<string, PanelConfig> = {
  ...
  'live-webcams': { name: 'Câmeras ao vivo', enabled: true, priority: 1 },
  insights: { name: 'Insights de IA', enabled: true, priority: 1 },
  cii: { name: 'Índice de instabilidade', enabled: true, priority: 1 },
  politics: { name: 'Notícias do mundo', enabled: true, priority: 1 },
  latam: { name: 'América Latina', enabled: true, priority: 1 },
  us: { name: 'Estados Unidos', enabled: true, priority: 1 },
  europe: { name: 'Europa', enabled: true, priority: 1 },
  asia: { name: 'Ásia-Pacífico', enabled: true, priority: 1 },
  markets: { name: 'Mercados', enabled: true, priority: 1 },
  economic: { name: 'Indicadores econômicos', enabled: true, priority: 1 },
  commodities: { name: 'Commodities', enabled: true, priority: 1 },
  crypto: { name: 'Cripto', enabled: true, priority: 2 },
  tech: { name: 'Tecnologia', enabled: true, priority: 2 },
  energy: { name: 'Energia e recursos', enabled: true, priority: 2 },
  polymarket: { name: 'Previsões', enabled: true, priority: 2 },
  'macro-signals': { name: 'Radar de mercado', enabled: true, priority: 2 },
  'satellite-fires': { name: 'Incêndios', enabled: true, priority: 2 },
  climate: { name: 'Anomalias climáticas', enabled: true, priority: 2 },
  displacement: { name: 'Deslocamento ACNUR', enabled: true, priority: 2 },
  natural: { name: 'Desastres naturais', enabled: true, priority: 2 },
...
// ============================================
export const DEFAULT_PANELS = SITE_VARIANT === 'happy' ? HAPPY_PANELS : SITE_VARIANT === 'tech' ? TECH_PANELS : SITE_VARIANT === 'finance' ? FINANCE_PANELS : SITE_VARIANT === 'br' ? BR_PANELS : FULL_PANELS;
export const DEFAULT_MAP_LAYERS = SITE_VARIANT === 'happy' ? HAPPY_MAP_LAYERS : SITE_VARIANT === 'tech' ? TECH_MAP_LAYERS : SITE_VARIANT === 'finance' ? FINANCE_MAP_LAYERS : SITE_VARIANT === 'br' ? BR_MAP_LAYERS : FULL_MAP_LAYERS;
export const MOBILE_DEFAULT_MAP_LAYERS = SITE_VARIANT === 'happy' ? HAPPY_MOBILE_MAP_LAYERS : SITE_VARIANT === 'tech' ? TECH_MOBILE_MAP_LAYERS : SITE_VARIANT === 'finance' ? FINANCE_MOBILE_MAP_LAYERS : SITE_VARIANT === 'br' ? BR_MOBILE_MAP_LAYERS : FULL_MOBILE_MAP_LAYERS;
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  // Brasil variant
  brNoticias: {
    labelKey: 'header.panelCatBrasilNews',
    panelKeys: ['live-news', 'politics', 'latam', 'us', 'europe', 'asia', 'insights'],
    variants: ['br'],
  },
  brMercados: {
    labelKey: 'header.panelCatBrasilMarkets',
    panelKeys: ['markets', 'economic', 'commodities', 'crypto', 'polymarket', 'macro-signals', 'monitors'],
    variants: ['br'],
  },
