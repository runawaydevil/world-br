...
const VARIANT_META: Record<string, {
  ...
  br: {
    title: 'Monitor Brasil - Inteligência e Notícias em Tempo Real',
    description: 'Dashboard de inteligência em tempo real com notícias, mercados, clima e dados do Brasil e da América Latina. Desenvolvido pelo Grupo Murad.',
    keywords: 'monitor brasil, notícias tempo real, mercados brasil, economia, América Latina, inteligência, Grupo Murad',
    url: 'https://br.worldmonitor.app/',
    siteName: 'Monitor Brasil',
    shortName: 'MonitorBrasil',
    subject: 'Inteligência e notícias em tempo real para o Brasil',
    classification: 'Dashboard de inteligência, Agregador de notícias',
    categories: ['news', 'productivity'],
    features: [
